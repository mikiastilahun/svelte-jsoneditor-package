...
import { DEFAULT_VISIBLE_SECTIONS, HOVER_COLLECTION, HOVER_INSERT_AFTER, HOVER_INSERT_INSIDE, INSERT_EXPLANATION } from '../../../constants';
import { getVisibleCaretPositions } from '../../../logic/documentState';
import { rename } from '../../../logic/operations';
import { createAfterSelection, createInsideSelection, createMultiSelection, fromCaretPosition, fromSelectionType, getEndPath, getSelectionPaths, isInsideSelection, isKeySelection, isPathInsideSelection, isValueSelection } from '../../../logic/selection';
import { encodeDataPath, getDataPathFromTarget, getSelectionTypeFromTarget, isChildOfAttribute, isChildOfNodeName, isContentEditableDiv } from '../../../utils/domUtils';
...
import { onMoveSelection } from '../../../logic/dragging';
import { forEachIndex, moveItems } from '../../../utils/arrayUtils';
import { SelectionType } from '../../../types';
import { getStartPath, isAfterSelection, isMultiSelection, selectionIfOverlapping } from '../../../logic/selection';
...
function handleMouseMove(event) {
    if (singleton.selecting) {
        ...
        if (!isEqual(path, singleton.selectionFocus) ||
            ...
            const json = context.getJson();
            context.onSelect(createMultiSelection(json, singleton.selectionAnchor, singleton.selectionFocus));
        }
    }
}
...
<style src="./JSONNode.scss">.jse-json-node {
  position: relative;
...
.jse-json-node.jse-root > .jse-header-outer :global(.jse-context-menu-button),
.jse-json-node.jse-root > .jse-contents-outer > .jse-contents :global(.jse-context-menu-button) {
  top: 0;
...
.jse-json-node .jse-footer {
  display: inline-flex;
  padding-left: calc(var(--jse-indent-size) + 5px);
}
...
.jse-json-node .jse-context-menu-button-anchor {
  position: relative;
}
...
.jse-json-node .jse-insert-area :global(.jse-context-menu-button) {
  right: -1px;
...
.jse-json-node.jse-selected .jse-meta,
...
.jse-json-node.jse-selected :global(.jse-value) {
  background: var(--jse-selection-background-color) !important;
  cursor: grab;
}
.jse-json-node.jse-selected .jse-expand {
  cursor: pointer;
...
.jse-json-node :global(.jse-collapsed-items.jse-selected), .jse-json-node.jse-selected :global(.jse-collapsed-items), .jse-json-node.jse-selected-value :global(.jse-collapsed-items) {
  ...
  cursor: grab;
  background-image: linear-gradient(var(--jse-collapsed-items-selected-background-color), var(--jse-collapsed-items-selected-background-color)), linear-gradient(to bottom right, transparent 50.5%, var(--jse-collapsed-items-selected-background-color) 50.5%), linear-gradient(to bottom left, transparent 50.5%, var(--jse-collapsed-items-selected-background-color) 50.5%), linear-gradient(to top right, transparent 50.5%, var(--jse-collapsed-items-selected-background-color) 50.5%), linear-gradient(to top left, transparent 50.5%, var(--jse-collapsed-items-selected-background-color) 50.5%);
}
...
.jse-json-node.jse-readonly .jse-header,
.jse-json-node.jse-readonly .jse-contents,
.jse-json-node.jse-readonly .jse-meta,
.jse-json-node.jse-readonly .jse-expand,
.jse-json-node.jse-readonly .jse-footer,
.jse-json-node.jse-readonly :global(.jse-key),
.jse-json-node.jse-readonly :global(.jse-value),
.jse-json-node.jse-readonly :global(.jse-collapsed-items) {
  cursor: default !important;
}
.jse-json-node .jse-insert-area.jse-selected {
  z-index: 2;
  outline-color: var(--jse-context-menu-button-background);
}
.jse-json-node .jse-insert-area.jse-selected :global(.jse-context-menu-button) {
  background: var(--jse-context-menu-button-background);
}
.jse-json-node .jse-insert-area.jse-selected :global(.jse-context-menu-button):hover {
  background: var(--jse-context-menu-button-background-highlight);
}

:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected .jse-header,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected .jse-contents,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected .jse-meta,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected .jse-expand,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected .jse-footer,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected :global(.jse-value) {
  background: var(--jse-selection-background-light-color) !important;
  cursor: grab;
}
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected .jse-expand {
  cursor: pointer;
}
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-key > .jse-contents-outer > .jse-contents > :global(.jse-identifier) > :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-key > .jse-header-outer > .jse-header > :global(.jse-identifier) > :global(.jse-key) {
  background: var(--jse-selection-background-light-color);
  cursor: grab;
}
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value > .jse-contents-outer > .jse-contents > :global(.jse-value) {
  background: var(--jse-selection-background-light-color);
  cursor: grab;
}
:global(.jse-main:not(.jse-focus)) .jse-json-node :global(.jse-collapsed-items.jse-selected), :global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected :global(.jse-collapsed-items), :global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value :global(.jse-collapsed-items) {
  background-color: var(--jse-selection-background-light-color);
  cursor: grab;
  background-image: linear-gradient(var(--jse-collapsed-items-selected-background-color), var(--jse-collapsed-items-selected-background-color)), linear-gradient(to bottom right, transparent 50.5%, var(--jse-collapsed-items-selected-background-color) 50.5%), linear-gradient(to bottom left, transparent 50.5%, var(--jse-collapsed-items-selected-background-color) 50.5%), linear-gradient(to top right, transparent 50.5%, var(--jse-collapsed-items-selected-background-color) 50.5%), linear-gradient(to top left, transparent 50.5%, var(--jse-collapsed-items-selected-background-color) 50.5%);
}
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-meta,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value > .jse-header-outer > .jse-header > .jse-meta,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value > .jse-footer-outer > .jse-footer,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-contents,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-header,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-footer,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-expand,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-contents,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-header,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-footer,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-expand {
  background: var(--jse-selection-background-light-color) !important;
}
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-meta :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-meta :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value > .jse-header-outer > .jse-header > .jse-meta :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value > .jse-header-outer > .jse-header > .jse-meta :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value > .jse-footer-outer > .jse-footer :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value > .jse-footer-outer > .jse-footer :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-contents :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-contents :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-header :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-header :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-footer :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-footer :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-expand :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-props .jse-expand :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-contents :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-contents :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-header :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-header :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-footer :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-footer :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-expand :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-selected-value .jse-items .jse-expand :global(.jse-value) {
  background: var(--jse-selection-background-light-color);
  cursor: grab;
}
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-readonly .jse-header,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-readonly .jse-contents,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-readonly .jse-meta,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-readonly .jse-expand,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-readonly .jse-footer,
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-readonly :global(.jse-key),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-readonly :global(.jse-value),
:global(.jse-main:not(.jse-focus)) .jse-json-node.jse-readonly :global(.jse-collapsed-items) {
  cursor: default !important;
}
:global(.jse-main:not(.jse-focus)) .jse-json-node .jse-insert-area.jse-selected {
  z-index: 2;
  outline-color: var(--jse-selection-background-color);
}
:global(.jse-main:not(.jse-focus)) .jse-json-node .jse-insert-area.jse-selected :global(.jse-context-menu-button) {
  background: var(--jse-selection-background-color);
}
:global(.jse-main:not(.jse-focus)) .jse-json-node .jse-insert-area.jse-selected :global(.jse-context-menu-button):hover {
  background: var(--jse-selection-background-color);
}
