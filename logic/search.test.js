...
import { createSearchAndReplaceAllOperations, createSearchAndReplaceOperations, findCaseInsensitiveMatches, replaceText, search, splitValue } from './search.js';
...
describe('search', () => {
    ...
    it('should limit search results to the provided max in case of multiple matches in a single field', () => {
        const maxResults = 4;
        assert.deepStrictEqual(search('ha', { greeting: 'ha ha ha ha ha ha' }, createDocumentState(), maxResults).length, maxResults);
        assert.deepStrictEqual(search('ha', { 'ha ha ha ha ha ha': 'ha ha ha ha ha ha' }, createDocumentState(), maxResults)
            .length, maxResults);
    });
    ...
    it('should split search results', () => {
        ...
        const extendedSearchResults = searchResults.map((item, index) => {
            return {
                ...item,
                active: index === 1
            };
