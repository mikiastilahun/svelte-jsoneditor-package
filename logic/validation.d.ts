...
export declare function validateJSON(json: JSONValue, validator: Validator | null, parser: JSONParser, validationParser: JSONParser): ValidationError[];
export declare function validateText(text: string, validator: Validator | null, parser: JSONParser, validationParser: JSONParser): ContentErrors;
