...
import { arrayStartsWith, arrayToObject, compareArrays, getNestedPaths, moveItems, objectToArray } from './arrayUtils.js';
describe('arrayUtils', () => {
    it('compareArrays', () => {
    ...
    describe('arrayStartsWith', () => {
        it('should test whether an array starts with the specified sub array', () => {
            ...
            assert.strictEqual(arrayStartsWith([{ id: 1 }, { id: 2 }, { id: 3 }], [{ id: 1 }, { id: 2 }]), true);
            assert.strictEqual(arrayStartsWith([{ id: 1 }, { id: 42 }, { id: 3 }], [{ id: 1 }, { id: 2 }]), false);
        });
        it('should use custom equality check in arrayStartsWith', () => {
            const users = [{ id: 1 }, { id: 2, name: 'Joe' }, { id: 3 }];
            const equalUserId = (a, b) => a.id === b.id;
