...
describe('convertToJSON', () => {
    ...
    it('throws an error when it cannot safely convert a bigint', () => {
        throws(() => convertToJSON(123456789012345678901234n), /Error: Cannot safely convert to number: the value 123456789012345678901234 would truncate and become 1\.2345678901234569e\+23/);
    });
    it('convert a LosslessNumber', () => {
        deepStrictEqual(convertToJSON(new LosslessNumber('4.0')), 4);
        deepStrictEqual(convertToJSON(new LosslessNumber('0.666666666666666666666666666666')), 0.6666666666666666);
    });
    it('throws an error when it cannot safely convert a LosslessNumber', () => {
        throws(() => convertToJSON(new LosslessNumber('123456789012345678901234')), /Error: Cannot safely convert to number: the value '123456789012345678901234' would truncate and become 1\.2345678901234569e\+23/);
    });
    it('convert Date', () => {
        deepStrictEqual(convertToJSON(new Date('2022-09-12T10:00:00Z')), 1662976800000);
    });
    it('convert an object', () => {
        deepStrictEqual(convertToJSON({
            bigint: 123n,
