 ...
 */
export declare function parseAndRepair(jsonText: string, parser: JSONParser): JavaScriptValue;
/**
 * Parse the JSON and if needed repair it.
 * When not valid, undefined is returned.
 */
export declare function parseAndRepairOrUndefined(partialJson: string, parser: JSONParser): JavaScriptValue | undefined;
export declare function parsePartialJson(partialJson: string, parse: (text: string) => JavaScriptValue): JavaScriptValue;
/**
 * Repair partial JSON
 */
 ...
 */
export declare function findTextLocation(text: string, path: JSONPath): TextLocation | null;
/**
 * Convert a JSON object, array, or value to another type
 * If it cannot be converted, an error is thrown
 */
export declare function convertValue(value: JSONValue, type: 'value' | 'object' | 'array', parser: JSONParser): JSONValue;
/**
